export default function MobileView() {
    return (
      <div className="h-screen flex flex-col items-center justify-center mobile-view">
        <svg
        ...
        <div className="mt-6 text-center">
          <h1 className="text-xl mb-2">Desktop Only</h1>
          <p className="text-secondary">
            Pinboard works best on a desktop browser. Open it on your computer
            to start pinning
          </p>
        </div>
      </div>
